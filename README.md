...
该仓库包含了我个人使用的一组 Codex / Claude Code / OpenClaw / Hermes Agent 技能，覆盖学术检索、论文研读、每日 AI 资讯、读书拆解、笔记管理、技术栈入门和 B 站缓存转换等场景。
...
| [daily-ai-news](./skills/daily-ai-news/) | 聚合和总结最新 AI 新闻，按重大公告、研究论文、产业商业、工具应用、政策伦理等类别生成每日简报，并附原文链接 |
| [paper-parse](./skills/paper-parse/) | 对学术论文 PDF 或 URL 进行双模式深度研读，生成面向研究者的专业解析和面向快速理解的核心逻辑提炼 |

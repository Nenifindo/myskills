...
- Reference grid alignment: ___px grid (if visible)
- Final XML grid alignment: 10px grid mandatory; round all positions, sizes, icon boxes, label boxes, and explicit connector points to multiples of 10.
